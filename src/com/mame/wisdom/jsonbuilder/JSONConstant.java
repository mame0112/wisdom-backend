...
public class JsonConstant {
	...
	public final static String PARAM_ERROR_MESSAGE = "error";

	/**
	 * JSON fields for user data
	 */
	...
	public final static String PARAM_WISDOM_MESSAGES = "messages";
